...
# "Cache-busting" cho static assets: mỗi lần server khởi động lại (mỗi lần
# deploy) tạo 1 số ngẫu nhiên mới, gắn vào cuối link CSS/JS trong template
# dạng ?v=xxxx. Nhờ vậy trình duyệt (đặc biệt trên điện thoại) luôn tải lại
# bản mới nhất của style.css/store.js... thay vì dùng bản cache cũ, tránh
# tình trạng giao diện lỗi vì CSS mới chưa được nạp sau khi cập nhật code.
